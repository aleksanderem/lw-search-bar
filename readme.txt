...
= 1.6.1 =
* Fix: EZIcons SDK — wstawianie tagu bezpośrednio przez wp_head z data-key (filtr script_loader_tag nie działał z Elementorem)
* Aktualizacja klucza API EZIcons
